...
const View = () => {
  ...
  if (showCertificate && certificate) {
    return (
      ...
      <button className="bg-blue-500 hover:bg-blue-600 ml-[100px] rounded-md p-2 text-xl mt-[20px] w-22 cursor-pointer" onClick={() => window.location.reload()}>Back</button>
    ...
    <div className=" min-h-screen">
      ...
      <div className="flex justify-center">
        <div className="mt-[180px]">
            <h1 className="text-3xl font-medium text-center">Credenza</h1>
            <img src={logo} alt="logo" className="h-[150px] mt-[70px] ml-[80px]"/> 
            ...
            <div className="mt-9">
                ...
                className="ml-4 p-2 bg-blue-500 text-white rounded-md cursor-pointer"
                >
                Search
                </button>
            </div>
